var background = (function() {
	...
	*/
	...
	async function deleteEmptyFolders(deps, folderIds) {
		...
		if (ids.some((id) => !emptyFolderIds.has(id))) throw new Error("待删除项不是当前扫描识别出的空文件夹，请重新检查");
